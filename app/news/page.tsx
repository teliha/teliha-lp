                  ...
                  {selectedItem.externalLink && (
                    <div className="mt-6">
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-400/10 border border-cyan-400/30 text-cyan-400 rounded-md hover:bg-cyan-400/20 transition-colors font-medium"
                      >
                        <span>{language === "en" ? "Read More" : "詳細を見る"}</span>
